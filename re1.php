...
<body>
    <div class="container">
        <header>
            <img src="Knxt_Shield_Logo_003C_T.png" alt="Kenexoft Logo" class="logo">
            <h1>Kenexoft - SHIELD</h1>
            <p>Secure Hybrid Intelligent Engine for Layered Defense</p>
        </header>

        <div class="plans-wrapper">
            <div class="plan-card" title="This plan includes basic security features">
                <h2>SHIELD - Essential</h2>
                <p>Price: <strong>$50.00/mo</strong></p>
                <ul>
                    <li><span class="info" title="Tracks unauthorized network activity">Firewall Logs</span></li>
                    <li><span class="info" title="Records website access">DNS Query Logs</span></li>
                    <li><span class="info" title="Monitors user activity for security">User Activity Logs</span></li>
                </ul>
            </div>

            <div class="plan-card" title="This plan includes advanced security features">
                <h2>SHIELD - Professional</h2>
                <p>Price: <strong>$45.00/mo</strong></p>
                <ul>
                    <li><span class="info" title="Tracks unauthorized network activity">Firewall Logs</span></li>
                    <li><span class="info" title="Records website access">DNS Query Logs</span></li>
                    <li><span class="info" title="Monitors user activity for security">User Activity Logs</span></li>
                    <li><span class="info" title="Analyzes network traffic">Network Traffic Logs</span></li>
                    <li><span class="info" title="Monitors email for security">Email Security Logs</span></li>
                </ul>
            </div>

            <div class="plan-card" title="This plan includes enterprise-level security features">
                <h2>SHIELD - Enterprise</h2>
                <p>Price: <strong>$70.00/mo</strong></p>
                <ul>
                    <li><span class="info" title="Tracks unauthorized network activity">Firewall Logs</span></li>
                    <li><span class="info" title="Records website access">DNS Query Logs</span></li>
                    <li><span class="info" title="Monitors user activity for security">User Activity Logs</span></li>
                    <li><span class="info" title="Analyzes network traffic">Network Traffic Logs</span></li>
                    <li><span class="info" title="Monitors email for security">Email Security Logs</span></li>
                    <li><span class="info" title="Tracks application-level activity">Application Logs</span></li>
                    <li><span class="info" title="Aggregates logs for advanced analysis">SIEM Systems Aggregated Logs</span></li>
                </ul>
            </div>
        </div>
